        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <div className="md:w-3/5 p-5 md:p-6 flex flex-col">
            ...
            <div className="mt-auto">
              ...
              <Link href={`/blog/${slug}`} className="inline-flex items-center gap-1 px-4 py-2 bg-white border-2 border-amber-500 text-amber-600 rounded-lg text-sm font-medium group-hover:bg-amber-500 group-hover:text-white transition-all duration-300">
                Read More
